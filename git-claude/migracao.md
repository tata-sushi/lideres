...
- ⏳ **Geração de novos ciclos aquisitivos** (linha nova por ano de admissão) ficou de fora — era o script standalone "Férias"; anotar p/ automatizar depois (Edge Function/cron a partir do `profiles.data_admissao`).
