-- ═══════════════════════════════════════════════════════════════════════════
-- Clima — limitador diário 5 → 7 links novos por dia
-- ---------------------------------------------------------------------------
-- Regra de disparo passa a "7 pessoas por dia". Única mudança vs. versão
-- anterior: v_limite_dia 5 → 7. A amostra do workflow n8n foi alinhada p/ 7.
-- (Mantém pausa, intervalo por pessoa e reaproveitamento de link ativo.)
-- ═══════════════════════════════════════════════════════════════════════════
...
declare
  ...
  v_limite_dia int := 7;   -- teto diário de links NOVOS
begin
