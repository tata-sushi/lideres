...
('exp60_lider', 'Experiência 60d — Líder', 1, 'lider_para_colab', 'desempenho', 'portal_lideres', 'admissao_60', '{"dias":60}', '{lider}', true, false,
 $json${
   "escala": "desempenho",
   "itens": [
     {"id":"adaptacao","tipo":"escala","dimensao":"Adaptação","texto":"O quanto se adaptou às rotinas e aceita mudanças/feedbacks de forma construtiva?"},
     {"id":"maturidade","tipo":"escala","dimensao":"Maturidade","texto":"O quanto lida bem com a pressão da rotina e mantém a postura em momentos de estresse?"},
     {"id":"responsabilidade","tipo":"escala","dimensao":"Responsabilidade","texto":"O quanto mantém dedicação, responsabilidade e compromisso?"},
     {"id":"etica","tipo":"escala","dimensao":"Ética","texto":"O quanto age com integridade e segue princípios éticos?"},
     {"id":"relacionamento","tipo":"escala","dimensao":"Relacionamento","texto":"O quanto mantém boas relações com colegas, superiores e/ou clientes?"},
     {"id":"comunicacao","tipo":"escala","dimensao":"Comunicação","texto":"O quanto se comunica de forma clara, objetiva e eficaz?"},
     {"id":"organizacao","tipo":"escala","dimensao":"Organização","texto":"O quanto organiza tarefas, gerencia o tempo e mantém o ambiente em ordem?"},
     {"id":"aprendizagem","tipo":"escala","dimensao":"Aprendizagem","texto":"O quanto demonstra interesse contínuo em aprender e evoluir desde a 1ª avaliação?"},
     {"id":"qualidade","tipo":"escala","dimensao":"Qualidade","texto":"O quanto mantém a preocupação em entregar trabalho de qualidade?"},
     {"id":"assiduidade","tipo":"escala","dimensao":"Assiduidade","texto":"O quanto cumpre os horários, jornadas e intervalos corretamente, além de avisar com antecedência sobre ausências?"},
     {"id":"uniforme","tipo":"escala","dimensao":"Uniforme","texto":"O quanto cuida e utiliza o uniforme corretamente?"},
     {"id":"cultura","tipo":"escala","dimensao":"Cultura","texto":"O quanto demonstra comportamentos alinhados à cultura do restaurante?"},
